...
function formatBytes(bytes, fraction = 1) {
 ...
 *
 * @param {File} file
 * @param {{ maxSize?: number, minSize?: number, accept?: string[] }} rules
 */
...
export { formatBytes, formatDuration, formatSpeed, matchAccept, validateFile }
