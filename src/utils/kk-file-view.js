...
export function encodeKkFileViewUrl(fileUrl) {
...
export function buildKkFileViewPreviewUrl(serviceBase, fileUrl, fileName) {
...
export function openKkFileViewPreview(filePath, fileName) {
